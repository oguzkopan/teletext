...
exports.getTrendArrowFromChange = getTrendArrowFromChange;
exports.getTrendColor = getTrendColor;
exports.getTrendColorFromChange = getTrendColorFromChange;
exports.formatTrendChange = formatTrendChange;
exports.formatMarketDataWithTrend = formatMarketDataWithTrend;
exports.createSparkline = createSparkline;
exports.getTrendAnimationClass = getTrendAnimationClass;
exports.generateMarketTrendCSS = generateMarketTrendCSS;
exports.createAnimatedPercentage = createAnimatedPercentage;
exports.formatMarketRow = formatMarketRow;
exports.createTrendSummary = createTrendSummary;
 ...
 */
function getTrendArrowFromChange(change) {
 ...
 */
function getTrendColorFromChange(change) {
 ...
 */
function formatTrendChange(change, options = {}) {
 ...
 */
function formatMarketDataWithTrend(data, options = {}) {
 ...
 * Uses characters: ▁ ▂ ▃ ▄ ▅ ▆ ▇ █
 */
function createSparkline(priceHistory, width = 20) {
 ...
 */
function getTrendAnimationClass(direction) {
    switch (direction) {
        case 'up':
 ...
 */
function generateMarketTrendCSS() {
    return `
 ...
 */
function createAnimatedPercentage(startValue, endValue, duration = 1000) {
 ...
 */
function formatMarketRow(symbol, price, changePercent, priceHistory) {
 ...
 */
function createTrendSummary(upCount, downCount, stableCount) {
    return `▲${upCount} ▼${downCount} ►${stableCount}`;
}
/**
 * Determines if a price movement is significant enough to animate
 */
function isSignificantChange(changePercent, threshold = 1.0) {
    return Math.abs(changePercent) >= threshold;
}
//# sourceMappingURL=market-trend-indicators.js.map