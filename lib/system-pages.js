...
exports.createSystemStatusPage = createSystemStatusPage;
exports.createHelpPage = createHelpPage;
/**
 * Creates page 101 - System Status
 */
function createSystemStatusPage() {
    const now = new Date();
...
//# sourceMappingURL=system-pages.js.map